			...
			<div class="panel">
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<input type="text" class="form-control" name="nilai_tesformatif" value="<?php echo $b->nilai_tesformatif;?>">
						</div>
					</div>
					<input type="submit" class="btn btn-primary" value="simpan">
					<a class="btn btn-primary btn-danger" data-toggle="tooltip" title="Tidak Jadi Edit Klik Cancel" href="<?php echo base_url('Admin/belajarharian/'); ?>">Cancel</a>
					</div>
			</div>
		</div>
	</form>
